...
import git.jeanvictor.cm.modelo.Campo;
import git.jeanvictor.cm.modelo.CampoEvento;
import git.jeanvictor.cm.modelo.CampoObservador;

@SuppressWarnings("serial")
public class BotaoCampo extends JButton 
	implements CampoObservador, MouseListener{
	
	private final Color BG_PADRAO = Color.BLUE;
	private final Color BG_ABERTO = new Color(184, 184, 184);
